...
import ReportOption from "../../utils/dropdowns/ReportOption";
// import ActionDropdown from "../../utils/dropdowns/ActionDropdown";
...
const PendingOrderTable = ({ tableData, refresh, isLoading }: Props) => {
  ...
  //     setSelectedOrders([]);
  //   } else {
  //     setSelectedOrders(tableData.map((item) => item.order_id));
  //   }
        ...
        >
          <thead>
            <tr>
              ...
              <th>Customer</th>
              <th>GST Number</th>
              <th>Receiver Address Book</th>
              <th>Sender Address Book</th>
              <th>Parcel Type</th>
            ...
            {isLoading || loading ? (
              ...
              tableData.map((item) => (
                <tr key={item.order_id}>
                  ...
                  <td>{item.docket_no && item.docket_no !== 0 ? item.docket_no : "-"}</td>
