...
import { deleteAddressbookAPI } from "../../../services/addressbook-service";
...
const AddressBookTable = ({ tableData, refresh }: Props) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const result = await deleteAddressbookAPI(selectedPaymentId);
      refresh();
      setLoading(false);
            ...
            <tr key={index}>
              ...
              {/* <td>
                <div className="btn-box">
                  ...
                  <button onClick={() => confirmDelete(item.address_book_id)}>
