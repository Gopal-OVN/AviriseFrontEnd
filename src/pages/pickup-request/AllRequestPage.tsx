...
// import { PickupRequestData, allDriverHeaderData } from "../../data";
...
import { PickupRequestData, pickupRequestHeaderData } from "../../data/index2";
  ...
  return (
    <div className="row g-4">
      <div className="col-12">
        <div className="panel">
          <TableHeader
            tableHeading="All Request"
            tableHeaderData={pickupRequestHeaderData}
            link="/create-request"
            showAddLink
          />
